...
//********************************* to do    oooooooooooooooooooooooooooooo */
 ...
 function GetVisted () {
  try {
     axios.get( AppConfig.API +'View/GetUsersVisits',{ headers: JSON.parse( window.localStorage.getItem("ldat"))}).then(response  =>{
   
       if(response.data){     
           appStore.Visited = response.data;   
            ...
            <Grid item xs={12} md={12} lg={12}>
              <Paper className={classes.fixedHeight2}>
                ...
                <div style={{width:'100%', display:'flex' , flexDirection:'row',justifyContent:"center" ,}}>
                  <Typography variant='h5' style={{marginTop:"10px",  marginBottom:"10px"}}> Visit  </Typography>
                </div>
              
                <Example data={appStore.Visited} />
