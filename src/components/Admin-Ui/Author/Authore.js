...
import AuthoreAdd from "./AuthorAdd";
...
async  function DeleteRequest(){
  ...
  try {
    var status =  ( await axios.delete(AppConfig.API+`Author/Delete/`+appStore.data[0].id ,{ headers: JSON.parse( window.localStorage.getItem("ldat"))}) ).status;
