...
const columns = [
  ...
  { field: "pole", headerName: "Pole", flex: 0.2 },
  {
    field: "color",
    headerName: "Action",
    flex: 0.2,
...
async  function DeleteRequest(){
 ...
 try {
    var status =  ( await axios.delete(AppConfig.API+`Pole/Delete/`+appStore.data[0].id ,{ headers: JSON.parse( window.localStorage.getItem("ldat"))}) ).status;
