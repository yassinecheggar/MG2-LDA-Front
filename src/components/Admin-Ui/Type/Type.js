...
const columns = [
  ...
  { field: "typedoc", headerName: "Type", flex: 0.8 },
...
async  function DeleteRequest(){
 ...
 try {
    var status =  ( await axios.delete(AppConfig.API+`Type/Delete/`+appStore.data[0].id ,{ headers: JSON.parse( window.localStorage.getItem("ldat"))}) ).status;
