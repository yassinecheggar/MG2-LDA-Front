...
import DelivrableAdd from "./DelivrableAdd";
...
const columns = [
  ...
  { field: "delivrable", headerName: "Nome", flex: 0.7 },
...
async  function DeleteRequest(){
 ...
 try {
    var status =  ( await axios.delete(AppConfig.API+`Delivrable/Delete/`+appStore.data[0].id ,{ headers: JSON.parse( window.localStorage.getItem("ldat"))}) ).status;
